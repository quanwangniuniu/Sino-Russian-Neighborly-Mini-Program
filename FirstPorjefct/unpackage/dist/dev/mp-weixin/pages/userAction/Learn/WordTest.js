...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    a: common_vendor.t($options.currentWord.russian),
    b: common_vendor.f($options.options, (option, index, i0) => {
      return {
        a: common_vendor.t(option),
        b: !$data.showNextQuestion || $data.selectedOption === index,
        c: "0a89e374-0-" + i0,
        d: $data.showWrong && $data.selectedOption === index ? 1 : "",
        e: $data.showCorrect && $options.currentWord.correctIndex === index ? 1 : "",
        f: $data.showNextQuestion && $data.selectedOption !== index ? 1 : "",
        g: common_vendor.o(($event) => $options.checkAnswer(index), index),
        h: index
      };
    }),
    c: common_vendor.p({
    ...
    d: $data.showNextQuestion,
    e: $data.showDefinition
  }, $data.showDefinition ? {
    f: common_vendor.t($options.currentWord.definition)
  } : {}, {
    g: $data.showNextQuestion
  }, $data.showNextQuestion ? {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-0a89e374"], ["__file", "F:/HBuilder/Uni-APP_project/FirstPorjefct/pages/userAction/Learn/WordTest.vue"]]);
